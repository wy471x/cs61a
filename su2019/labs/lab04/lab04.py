...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    des_city = make_city('', lat, lon)
    city1_distance = distance(city1, des_city)
    city2_distance = distance(city2, des_city)
    return get_name(city2) if city1_distance > city2_distance else get_name(city1)
